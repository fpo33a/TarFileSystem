...
public class TarFileSystem extends FileSystem {
  ...
  public void initialize(URI name, Configuration conf) throws IOException {
    LOG.info("*** Using Tar file FP system - ***"+name);
    ...
    LOG.info("*** initialize - ***"+getBaseTarPath(new Path(name)));
  ...
  public FSDataInputStream open(Path f, int bufferSize) throws IOException {
    ...
    LOG.info("*** opening - ***"+f.toString()+", path "+baseTarPath.toString());
     this.index = new TarIndex(
          underlyingFS,
          baseTarPath, true, this.configuration);
